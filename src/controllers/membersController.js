    ...
    try{
        ...
        if(existMember.length > 0){
            ...
            const newMember = {
                ...
                member_fee: body && body.member_fee ? body.member_fee : null,
                pending_member_fee: body && body.pending_member_fee ? body.pending_member_fee : null,
                maintenance: body && body.maintenance ? body.maintenance : null,
                pending_maintenance: body && body.pending_maintenance ? body.pending_maintenance : null,
                transfer_fee: body && body.transfer_fee ? body.transfer_fee : null,
                pending_transfer_fee: body && body.pending_transfer_fee ? body.pending_transfer_fee : null,
                share_capital: body && body.share_capital ? body.share_capital : null,
                pending_share_capital: body && body.pending_share_capital ? body.pending_share_capital : null,
                land_amount: body && body.land_amount ? body.land_amount : null,
                pending_land_amount: body && body.pending_land_amount ? body.pending_land_amount : null,
                construction_fund: body && body.construction_fund ? body.construction_fund : null,
                pending_construction_fund: body && body.pending_construction_fund ? body.pending_construction_fund : null,
                n_a_conversion_amount: body && body.n_a_conversion_amount ? body.n_a_conversion_amount : null,
                pending_n_a_conversion_amount: body && body.pending_n_a_conversion_amount ? body.pending_n_a_conversion_amount : null,
                deposit: body && body.deposit ? body.deposit : null,
                pending_deposit: body && body.pending_deposit ? body.pending_deposit : null,
            }
